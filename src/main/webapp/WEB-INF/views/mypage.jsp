...
<body>
        ...
        <section class="px-md-5 mx-md-5 text-center text-lg-left dark-grey-text">
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-md-6">
                    ...
                    <form class="text-center" action="updateMember.do" method="POST">
						...
						<button  class="btn btn-info btn-block mb-3 font-weight-bold" type="button" onclick="location.href='beginningTutor.do'" method="GET">튜터되기</button>
                    </form>
                    <!-- Default form subscription -->
                </div>
                <!--Grid column-->
	...
	<div class="mypage_container">
		<%-- <h1>${loginMember.nickname }님MyPage입니다.</h1>
		...
		<%-- <div style="border: 10px soild red;">
			<form action="">
				<h1>내 강의 공고</h1>
				<c:if test="${loginMember.istutor eq false }">
					<p>튜터등록 이후 이용이 가능합니다.</p>
				</c:if>
		...
		내 구매내역 : ${myPayList }
		<br>
		바로마이페이지 이동시 결제된 강의 정보-2 : ${myLecture }
		<br>
		현재 강의 기록 : ${history }
		<br>
		강의 기록이 있으면 오는 특정강의 : ${lec }
		<br>
		<table>
			<tr>
				<th>
